...
s0_maximize_match = 
s0_no_argb_match = 
s0_no_move_match = (class=Firefox) | class=ubuntu-amazon-default | class=Totem
s0_no_resize_match = (class=Firefox) | class=ubuntu-amazon-default | class=Totem
s0_no_minimize_match = (class=Firefox) | class=ubuntu-amazon-default | class=Totem
s0_no_maximize_match = (class=Firefox) | class=ubuntu-amazon-default | class=Totem
s0_no_close_match = (class=Firefox) | class=ubuntu-amazon-default | class=Totem
s0_no_focus_match = class=Firefox
s0_size_matches = class=Firefox;class=ubuntu-amazon-default;class=Totem;
s0_size_width_values = 1850;1850;1850;
s0_size_height_values = 300;300;300;
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;place;mousepoll;wall;imgpng;resize;snap;grid;regex;move;winrules;animation;fade;scale;expo;unityshell;
...
s0_mode = 2
s0_multioutput_mode = 0
s0_force_placement_match = (class=Firefox) & class=ubuntu-amazon-default
s0_position_matches = class=Firefox;class=ubuntu-amazon-default;class=Totem;
s0_position_x_values = 0;0;0;
s0_position_y_values = 0;350;800;
s0_position_constrain_workarea = true;true;true;
s0_mode_matches = 
s0_mode_modes = 
s0_viewport_matches = ;
s0_viewport_x_values = 1;
